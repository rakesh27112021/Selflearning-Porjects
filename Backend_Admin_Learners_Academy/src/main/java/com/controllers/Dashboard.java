...
public class Dashboard extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(loggeduname!=null){
			...
			if (request.getParameter("If-Modified-Since") == null && request.getParameter("searchByClass")!=null && request.getParameter("searchByClass").equals("searchByClass") && request.getParameter("classId")!=null)
			{
